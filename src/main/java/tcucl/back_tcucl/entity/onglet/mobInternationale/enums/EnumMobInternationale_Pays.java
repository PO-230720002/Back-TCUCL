...
public enum EnumMobInternationale_Pays {
    ...
    ARMENIE(4, "Arménie", true,3417,true),
    AUTRICHE(5, "Autriche", true,1037,true),
    BELGIQUE(6, "Belgique", true,263,true),
    BIELORUSSIE(7, "Biélorussie", true,1826,true),
    BOSNIE_HERZEGOVINE(8, "Bosnie-Herzégovine", true,1347,true),
    ...
    GRECE(17, "Grèce", true,2110,true),
    GEORGIE(18, "Géorgie", true,3370,true),
    ...
    MACEDOINE_DU_NORD(26, "Macédoine du Nord", true,1710,true),
    ...
    NORVEGE(31, "Norvège", true,1359,true),
    ...
    ALGERIE(49, "Algérie", false,1373,false),
    ...
    ANTILLES_NEERLANDAISES(53, "Antilles néerlandaises", false,6764,false),
    ...
    BRESIL(71, "Brésil", false,9194,false),
    ...
    COOK_ILES(82, "Cook (îles)", false,16558,false),
    COREE_DU_NORD(83, "Corée du Nord", false,8770,false),
    COREE_DU_SUD(84, "Corée du Sud", false,8966,false),
    COSTA_RICA(85, "Costa Rica", false,8909,false),
    COTE_D_IVOIRE(86, "Côte d'Ivoire", false,4602,false),
    CUBA(87, "Cuba", false,7602,false),
    DJIBOUTI(88, "Djibouti", false,5527,false),
    DOMINIQUE(89, "Dominique", false,6801,false),
    EGYPTE(90, "Égypte", false,3209,false),
    EMIRATS_ARABES_UNIS(91, "Émirats Arabes Unis", false,5239,false),
    EQUATEUR(92, "Équateur", false,9427,false),
    ERYTHREE(93, "Érythrée", false,5054,false),
    ETATS_FEDERES_DE_MICRONESIE(94, "États Fédérés de Micronésie", false,13380,false),
    ETATS_UNIS(95, "États-Unis", false,7934,false),
    ETHIOPIE(96, "Éthiopie", false,5586,false),
    FIDJI_ILES(97, "Fidji (îles)", false,16561,false),
    FEROE_ILES(98, "Féroé (îles)", false,1583,false),
    ...
    GUINEE(107, "Guinée", false,4396,false),
    GUINEE_EQUATORIALE(108, "Guinée Équatoriale", false,5301,false),
    GUINEE_BISSAU(109, "Guinée-Bissau", false,4399,false),
    GUYANA(110, "Guyana", false,7525,false),
    GEORGIE_DU_SUD_ET_ILES_SANDWICH(111, "Géorgie du Sud et îles Sandwich", false,12068,false),
    HAITI(112, "Haïti", false,7325,false),
    HONDURAS(113, "Honduras", false,8674,false),
    HONG_KONG(114, "Hong Kong", false,9600,false),
    INDE(115, "Inde", false,6572,false),
    INDONESIE(116, "Indonésie", false,12394,false),
    ...
    JAMAIQUE(121, "Jamaïque", false,7745,false),
    ...
    KOWEIT(128, "Koweït", false,4379,false),
    ...
    LIBERIA(133, "Libéria", false,4840,false),
    ...
    MALOUINES_ILES(140, "Malouines (îles)", false,12642,false),
    MAROC(141, "Maroc", false,2131,false),
    MARSHALL_ILES(142, "Marshall (îles)", false,13694,false),
    MARTINIQUE(143, "Martinique", false,6845,false),
    MAURICE_ILE(144, "Maurice (île)", false,9457,false),
    ...
    NIGERIA(154, "Nigéria", false,4724,false),
    NIUE(155, "Niué", false,16626,false),
    NOUVELLE_CALEDONIE(156, "Nouvelle-Calédonie", false,16626,false),
    NOUVELLE_ZELANDE(157, "Nouvelle-Zélande", false,18545,false),
    NEPAL(158, "Népal", false,7119,false),
    OMAN(159, "Oman", false,5704,false),
    OUGANDA(160, "Ouganda", false,6024,false),
    OUZBEKISTAN(161, "Ouzbékistan", false,4744,false),
    ...
    PAPOUASIE_NOUVELLE_GUINEE(166, "Papouasie-Nouvelle-Guinée", false,14206,false),
    PARAGUAY(167, "Paraguay", false,10003,false),
    PHILIPPINES(168, "Philippines", false,10743,false),
    POLYNESIE_FRANCAISE(169, "Polynésie Française", false,15711,false),
    PORTO_RICO(170, "Porto Rico", false,6962,false),
    PEROU(171, "Pérou", false,10287,false),
    QATAR(172, "Qatar", false,4979,false),
    RWANDA(173, "Rwanda", false,6250,false),
    REPUBLIQUE_CENTRAFRICAINE(174, "République Centrafricaine", false,4973,false),
    REPUBLIQUE_DOMINICAINE(175, "République Dominicaine", false,7182,false),
    REPUBLIQUE_DEMOCRATIQUE_DU_CONGO(176, "République Démocratique du Congo", false,3019,false),
    REUNION_ILE(177, "Réunion (île)", false,9391,false),
    RUSSIE(178, "Russie", false,2456,false),
    SAINT_CHRISTOPHE_ET_NIEVES(179, "Saint-Christophe-et-Niévès", false,6755,false),
    ...
    SALOMON_ILES(182, "Salomon (îles)", false,15512,false),
    SALVADOR(183, "Salvador", false,8945,false),
    SAMOA_ILES(184, "Samoa (îles)", false,16084,false),
    SAMOA_AMERICAINES(185, "Samoa Américaines", false,16120,false),
    SAO_TOME_ET_PRINCIPE(186, "Sao Tomé-et-Principe", false,5339,false),
    ...
    SENEGAL(196, "Sénégal", false,4221,false),
    TADJIKISTAN(197, "Tadjikistan", false,5414,false),
    TANZANIE(198, "Tanzanie", false,6874,false),
    TAIWAN(199, "Taïwan", false,9892,false),
    TCHAD(200, "Tchad", false,4059,false),
    THAILANDE(201, "Thaïlande", false,9438,false),
    TIMOR_ORIENTAL(202, "Timor Oriental", false,13150,false),
    TOGO(203, "Togo", false,4770,false),
    TONGA_ILES(204, "Tonga (îles)", false,18867,false),
    TRINITE_ET_TOBAGO(205, "Trinité-et-Tobago", false,7151,false),
    TUNISIE(206, "Tunisie", false,1489,false),
    TURKMENISTAN(207, "Turkménistan", false,4558,false),
    ...
    WALLIS_ET_FUTUNA_ILES(213, "Wallis et Futuna (îles)", false,16172,false),
    YEMEN(214, "Yémen", false,5512,false),
    ZAMBIE(215, "Zambie", false,7484,false),
    ZIMBABWE(216, "Zimbabwe", false,8018,false),
    AUTRE(217, "Autre:", false,0,false);

//ecosse et kosovo présent dans le fichier de distance de l'excel mais pas dans celui dse destinations de la catho
