...
public class AchatOngletServiceImpl implements AchatOngletService {
    ...
    public AchatResultatDto getAchatResultat(Long ongletId) {
        ...
        resultat.setPapier_nb(
                onglet.getAchatConsommable().getPapier_nb() * facteurEmissionParametre);
        ...
        resultat.setLivres_nb(
                onglet.getAchatConsommable().getLivres_nb() * facteurEmissionParametre);
        ...
        resultat.setPetitesFournitures_Eur(
                onglet.getAchatConsommable().getPetitesFournitures_Eur() * facteurEmissionParametre);
        ...
        resultat.setNbFeuillesImprimeesJetEncre_Nb(
                onglet.getAchatConsommable().getNbFeuillesImprimeesJetEncre_Nb() * facteurEmissionParametre);
        ...
        resultat.setNbFeuillesImprimeesToner_Nb(
                onglet.getAchatConsommable().getNbFeuillesImprimeesToner_Nb() * facteurEmissionParametre);
        ...
        resultat.setProduitsPharmaceutiques_Eur(
                onglet.getAchatConsommable().getProduitsPharmaceutiques_Eur() * facteurEmissionParametre);
        ...
        switch (onglet.getAchatRestauration().getMethodeCalcul()){
            case METHODE_RAPIDE -> {
                ...
                resultat.setMethodeRapideNombrePersonnesServiesRegimeClassique(
                        onglet.getAchatRestauration().getMethodeRapideNombrePersonnesServiesRegimeClassique() * facteurEmissionParametre);
                ...
                resultat.setMethodeRapideNombrePersonnesServiesRegimeFlexitarien(
                        onglet.getAchatRestauration().getMethodeRapideNombrePersonnesServiesRegimeFlexitarien() * facteurEmissionParametre);
            }
            case METHODE_INTERMEDIAIRE -> {
                ...
                resultat.setNombreRepasServisDominanteAnimaleBoeuf(
                        onglet.getAchatRestauration().getNombreRepasServisDominanteAnimaleBoeuf() * facteurEmissionParametre);
                ...
                resultat.setNombreRepasServisDominanteAnimalePoulet(
                        onglet.getAchatRestauration().getNombreRepasServisDominanteAnimalePoulet() * facteurEmissionParametre);
                ...
                resultat.setNombreRepasServisDominanteVegetaleBoeuf(
                        onglet.getAchatRestauration().getNombreRepasServisDominanteVegetaleBoeuf() * facteurEmissionParametre);
                ...
                resultat.setNombreRepasServisDominanteVegetalePoulet(
                        onglet.getAchatRestauration().getNombreRepasServisDominanteVegetalePoulet() * facteurEmissionParametre);
                ...
                resultat.setNombreRepasServisDominanteClassiqueBoeuf(
                        onglet.getAchatRestauration().getNombreRepasServisDominanteClassiqueBoeuf() * facteurEmissionParametre);
                ...
                resultat.setNombreRepasServisDominanteClassiquePoulet(
                        onglet.getAchatRestauration().getNombreRepasServisDominanteClassiquePoulet() * facteurEmissionParametre);
                ...
                resultat.setNombreRepasServisRepasMoyen(
                        onglet.getAchatRestauration().getNombreRepasServisRepasMoyen() * facteurEmissionParametre);
                ...
                resultat.setNombreRepasServisRepasVegetarien(
                        onglet.getAchatRestauration().getNombreRepasServisRepasVegetarien() * facteurEmissionParametre);
            }
